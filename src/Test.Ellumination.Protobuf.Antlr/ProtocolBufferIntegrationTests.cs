...
namespace Ellumination.Protobuf
{
    ...
    public class ProtocolBufferIntegrationTests : TestFixtureBase
    {
        ...
        public static IEnumerable<object[]> ProtocolBufferIntegrationCases { get; }
            = new ProtocolBufferIntegrationTestCases().ToArray();
        ...
        [Theory
            , MemberData(nameof(ProtocolBufferIntegrationCases), DisableDiscoveryEnumeration = true)
            //, ClassData(typeof(ProtocolBufferIntegrationTestCases))
            ]
